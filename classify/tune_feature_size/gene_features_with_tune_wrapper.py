...
def main():
    ...
    if args.method == 0:
        ...
        run_args = [
            "python",
            "/home/1546/code/keyword_extraction/classify/tune_feature_size/gene_features_for_words_with_tune.py",
            positive_file,
            negative_file,
            cate_file,
            dest_dir,
        ...
        run_args = [
            "python",
            "/home/1546/code/keyword_extraction/classify/tune_feature_size/gene_features_for_verbs_with_tune.py",
            cate_file,
            dest_dir,
            "-pf", positive_file,
            "-nf", negative_file,
